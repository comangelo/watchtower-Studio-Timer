import { FileText, MessageCircle, HelpCircle, Image, BookOpen } from "lucide-react";
  ...
  return (
    <Card className={`mb-8 shadow-sm ${darkMode ? 'border-zinc-600 bg-zinc-800' : 'border-zinc-100'}`} data-testid="analysis-summary">
      <CardContent className="p-6">
        ...
        {/* Stats Pills Row - Minimalista y llamativa */}
        <div className="flex flex-wrap gap-2 mb-6">
          {/* Preguntas de párrafos */}
          <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-medium transition-all ${
            ...
            <span className={`${darkMode ? 'text-orange-300/70' : 'text-orange-600/70'}`}>preguntas</span>
          </div>
